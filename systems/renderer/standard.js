...
export default function createStandardRendererSystem(opts) {
  ...
  const flagDefs = [
    ...
    [["material", "specularMap"], "SPECULAR_MAP", { type: "texture", uniform: "uSpecularMap" }],
    [["material", "specularColor"], "USE_SPECULAR_COLOR", { uniform: "uSpecularColor" }],
    [["material", "specularColorMap"], "SPECULAR_COLOR_MAP", { type: "texture", uniform: "uSpecularColorMap" }],
